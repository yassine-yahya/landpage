...
const skillGroups = [
  { cat: "Programming",             label: "#a371f7", tags: ["Python", "JavaScript"] },
  { cat: "Web development",         label: "#388bfd", tags: ["HTML", "CSS", "React.js", "Node.js", "Next.js", "Express.js", "Bootstrap", "Tailwind", "REST APIs"] },
  { cat: "Data science / analysis", label: "#3fb950", tags: ["SQL", "PostgreSQL", "MongoDB", "NumPy", "Pandas", "Matplotlib", "NoSQL"] },
  { cat: "DevOps / systems",        label: "#f0883e", tags: ["Git", "GitHub", "Docker", "Linux", "Bash", "Agile / Scrum", "Airtable"] },
  { cat: "Security",                label: "#ff7b72", tags: ["SIEM (SOC)", "Wireshark", "Nmap", "Metasploit", "Incident Response", "OAuth", "JWT"] },
  { cat: "Design / UX",             label: "#79c0ff", tags: ["Figma", "Canva", "UX/UI Design"] },
];

const experience = [
  {
    title: "Project Assistant", company: "Migracode – Open Cultural Center",
...
const certifications = [
  {
    name: "Education & Innovation", org: "International Training Center, Prague",
    detail: "1 Week · May 2026", accent: GH.blue, inProgress: false,
    skills: ["AI Tools for Education", "Flipped Classroom", "Digital Learning", "Project-Based Learning", "Instructional Design", "Collaborative Learning", "Educational Technology", "Innovation in Education"]
  },
  {
...
export default function Portfolio() {
    ...
    style.textContent = `
      *{box-sizing:border-box;margin:0;padding:0;}
      ...
      @media(max-width:900px){
        ...
        .hero-qr img{width:100px!important;height:100px!important;}
        .cta-r{justify-content:center!important;}
      }
      @media(max-width:660px){
        .dnav{display:none!important;} .hmb{display:flex!important;}
        .htitle{font-size:36px!important;line-height:1.1!important;}
  ...
  const SEC_NUM = { About:"01", Skills:"02", Experience:"03", Projects:"04", Certifications:"05", Education:"06", Contact:"07" };
    ...
    <div style={{ background: GH.bg, color: GH.text, fontFamily: "'Outfit', system-ui, sans-serif", minHeight: "100vh" }}>
        ...
        <div className="hero-row" style={{
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
            ...
            <p className="fu1" style={{
              ...
              maxWidth: "520px", marginBottom: "2rem", fontWeight: 300,
            }}>
        ...
        <div className="fu4" style={{ width: "100%", display: "flex", justifyContent: "center", marginBottom: "2rem" }}>
          <div style={{
            ...
            <span style={{ fontSize: "13px", color: GH.textSec, lineHeight: 1.5 }}>
              This portfolio is <span style={{ color: GH.green, fontWeight: 600 }}>always evolving</span> — come back anytime to discover new projects, skills & experiences
            </span>
          </div>
        </div>
      ...
      <section id="about" className="sec" style={{ padding: "4rem 1.5rem", maxWidth: "960px", margin: "0 auto" }}>
        <div ref={aboutRef} className={aboutInView ? "section-glow" : ""}>
          ...
          <h2 style={{ fontSize: "32px", fontWeight: 700, marginBottom: "1.75rem", letterSpacing: "-0.02em", lineHeight: 1.2, ...reveal(aboutInView, 0.05) }}>
            Finance veteran turned<br />full-stack developer.
          </h2>
        ...
        <div ref={skillsRef} className={skillsInView ? "section-glow" : ""}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            {skillGroups.map((g, gi) => (
              <div key={g.cat} style={{ display: "flex", alignItems: "flex-start", gap: "20px", ...reveal(skillsInView, 0.1 + gi * 0.07) }}>
                <span style={{
                  ...
                  {g.tags.map((tag, ti) => (
                    <span key={tag}
                      ...
                      style={{
                        ...
                        border: `1px solid ${GH.border}`, cursor: "default",
      ...
      <section id="experience" className="sec" style={{ padding: "4rem 1.5rem", maxWidth: "960px", margin: "0 auto" }}>
        <div ref={expRef} className={expInView ? "section-glow" : ""}>
          ...
          <div className="exp-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
            {experience.map((exp, i) => (
              <div key={i} className="exp-card" style={{
                background: GH.surface, borderRadius: "8px",
                padding: "1.25rem 1.5rem", border: `1px solid ${GH.border}`,
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "10px", flexWrap: "wrap", gap: "8px" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "5px" }}>
                    <span style={{ fontSize: "12px", padding: "3px 10px", borderRadius: "20px", background: "rgba(255,255,255,0.06)", color: GH.textSec, fontFamily: "'Space Mono', monospace", display: "flex", alignItems: "center", gap: "5px" }}>
                      <span style={{ fontSize: "10px" }}>📅</span> {exp.period}
                    </span>
                    <span style={{ fontSize: "11px", padding: "2px 10px", borderRadius: "20px", background: "rgba(255,255,255,0.04)", color: GH.textSec, display: "flex", alignItems: "center", gap: "5px" }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "5px" }}>
                  {exp.tags.map(tag => (
                    <span key={tag} style={{ fontSize: "11px", padding: "3px 10px", borderRadius: "20px", background: "rgba(255,255,255,0.05)", color: GH.textSec, cursor: "default" }}>{tag}</span>
                  ))}
                </div>
              </div>
            ))}
      ...
      <section id="certifications" className="sec" style={{ padding: "4rem 1.5rem", maxWidth: "960px", margin: "0 auto" }}>
        <div ref={certRef} className={certInView ? "section-glow" : ""}>
          <SectionLabel text="Certifications & Education" inView={certInView} />
              ...
              <div key={i} className="cert-card" style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "8px" }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <span style={{ fontSize: "12px", fontFamily: "'Space Mono', monospace", color: GH.text, fontWeight: 700, background: "rgba(255,255,255,0.07)", padding: "3px 10px", borderRadius: "4px" }}>{c.detail}</span>
                  </div>
                  {c.inProgress && (
                    <span style={{ fontSize: "10px", fontWeight: 700, padding: "3px 8px", borderRadius: "20px", background: "rgba(240,136,62,0.15)", color: GH.orange, whiteSpace: "nowrap", flexShrink: 0, letterSpacing: "0.06em", textTransform: "uppercase" }}>In Progress</span>
                  )}
                </div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "5px" }}>
                  {c.skills.map(skill => (
                    <span key={skill} style={{ fontSize: "11px", padding: "3px 9px", borderRadius: "20px", background: "rgba(255,255,255,0.05)", color: GH.textSec, fontWeight: 400 }}>{skill}</span>
                  ))}
                </div>
              </div>
            ))}
      ...
      <section id="education" className="sec" style={{ padding: "4rem 1.5rem", maxWidth: "960px", margin: "0 auto" }}>
        <div ref={eduRef} className={eduInView ? "section-glow" : ""}>
          <SectionLabel text="Education" inView={eduInView} />
          <h2 style={{ fontSize: "32px", fontWeight: 700, marginBottom: "2rem", letterSpacing: "-0.02em", ...reveal(eduInView, 0.05) }}>Workshops & languages</h2>
      ...
      <section id="projects" className="sec" style={{ padding: "4rem 1.5rem", maxWidth: "960px", margin: "0 auto" }}>
        <div ref={projRef} className={projInView ? "section-glow" : ""}>
          ...
          <div className="proj-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", width: "100%" }}>
              ...
              return (
                <div key={p.id} className="proj-card" style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
                    <span style={{ fontSize: "11px", fontFamily: "'Space Mono', monospace", color: extColor, background: `${extColor}15`, padding: "3px 8px", borderRadius: "4px", maxWidth: "65%", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{p.fileName}</span>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "16px" }}>
                    {p.tech.map(t => (
                      <span key={t} style={{ fontSize: "11px", padding: "3px 10px", borderRadius: "20px", background: "rgba(56,139,253,0.10)", color: GH.blue, fontWeight: 500 }}>{t}</span>
                    ))}
                  </div>
            ...
            <a href="https://github.com/yassine-yahya" target="_blank" rel="noopener noreferrer"
              className="proj-card"
              style={{
                gridColumn: window.innerWidth <= 660 ? "span 1" : "span 2", background: "rgba(56,139,253,0.06)",
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: "13px", color: GH.textSec, margin: 0, fontWeight: 300 }}>Explore more projects, experiments, and open-source contributions</p>
                </div>
              </div>
              <span style={{ fontSize: "13px", color: GH.blue, whiteSpace: "nowrap", fontFamily: "'Space Mono', monospace" }}>github.com/yassine-yahya →</span>
            </a>
          </div>
        </div>
      </section>
        ...
        <div ref={footerRef}>
          <div className="fg" style={{ display: "grid", gridTemplateColumns: "1.6fr 1fr 1fr", gap: "2rem", marginBottom: "2.5rem" }}>
            ...
            <div style={{ ...reveal(footerInView, 0.0) }}>
              ...
              <p style={{ fontSize: "13px", color: GH.textSec, lineHeight: 1.75, marginBottom: "1.25rem", maxWidth: "230px", fontWeight: 300 }}>
                Data Science & Full-Stack specialist — building data-driven web applications that solve real-world problems.
              </p>
              ...
              <div style={{ marginTop: "20px" }}>
                ...
                <div style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", gap: "8px", padding: "10px" }}>
                  <img src={qrImage} alt="QR Code" style={{ width: "100px", height: "100px", display: "block", objectFit: "cover" }} />
                  <span style={{ fontSize: "10px", color: GH.textMut, fontFamily: "'Space Mono', monospace" }}>Curriculum Vitae</span>
                </div>
              </div>
            </div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "8px", ...reveal(footerInView, 0.25) }}>
            ...
            <button onClick={() => scrollTo("home")} style={{
              ...
              fontSize: "12px", color: GH.blue, padding: "5px 14px", borderRadius: "6px", fontFamily: "inherit",
            }}
